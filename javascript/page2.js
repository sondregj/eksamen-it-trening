...
function setup() {
  futura_pt_medium = loadFont('eksamen-it-trening/fonts/futura-pt-medium.ttf', checkload);
  futura_pt_book = loadFont('eksamen-it-trening/fonts/futura-pt-book.ttf', checkload);
  loadcount = 0;
